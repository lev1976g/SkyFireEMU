...
struct AchievementCriteriaEntry
{
    ...
    uint32  timedCriteriaStartType;                         // 11       _timer_start_event Only appears with timed achievements, seems to be the type of starting a timed Achievement, only type 1 and some of type 6 need manual starting
    ...
    uint32  timedCriteriaMiscId;                            // 12       _timer_asset_id Alway appears with timed events, used internally to start the achievement, store
    uint32  timeLimit;                                      // 13       _timer_time time limit in seconds
