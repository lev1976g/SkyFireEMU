...
void InitOpcodeTable()
{
    ...
    OPCODE( CMSG_CHARACTER_CREATE,                        STATUS_AUTHED,   PROCESS_THREADUNSAFE,  &WorldSession::HandleCharCreateOpcode          );
    OPCODE( CMSG_CHARACTER_ENUM,                          STATUS_AUTHED,   PROCESS_THREADUNSAFE,  &WorldSession::HandleCharEnumOpcode            );
    OPCODE( CMSG_CHARACTER_DELETE,                        STATUS_AUTHED,   PROCESS_THREADUNSAFE,  &WorldSession::HandleCharDeleteOpcode          );
    OPCODE( SMSG_CHARACTER_CREATE,                        STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_CHARACTER_ENUM,                          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( SMSG_CHARACTER_DELETE,                        STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( CMSG_CHANNEL_MODERATOR,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    ...
    OPCODE( CMSG_WORLD_PORT_RESPONSE,                     STATUS_TRANSFER, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveWorldportAckOpcode    );
    OPCODE( SMSG_MONSTER_MOVE,                            STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_SET_WATER_WALK,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_SET_LAND_WALK,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( MSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK,              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    //OPCODE( SMSG_FORCE_RUN_BACK_SPEED_CHANGE,             STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK,         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    //OPCODE( SMSG_FORCE_SWIM_SPEED_CHANGE,                 STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleForceSpeedChangeAck       );
    //OPCODE( SMSG_FORCE_MOVE_ROOT,                         STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_FORCE_MOVE_ROOT_ACK,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveRootAck               );
    //OPCODE( SMSG_FORCE_MOVE_UNROOT,                       STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_FORCE_MOVE_UNROOT_ACK,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveUnRootAck             );
    ...
    OPCODE( MSG_MOVE_KNOCK_BACK,                          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_KNOCK_BACK_ACK,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveKnockBackAck          );
    OPCODE( MSG_MOVE_KNOCK_BACK,                          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_NULL                     );
    OPCODE( MSG_MOVE_SET_FEATHER_FALL,                    STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_SET_NORMAL_FALL,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_SET_HOVERING,                        STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_UNSET_HOVERING,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_HOVER_ACK,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveHoverAck              );
    ...
    OPCODE( CMSG_CHARACTER_RENAME,                        STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleCharRenameOpcode          );
    OPCODE( SMSG_CHARACTER_RENAME,                        STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( CMSG_BATTLEMASTER_JOIN_ARENA,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleBattlemasterHelloOpcode   );
    ...
    //OPCODE( MSG_MOVE_SPLINE_SET_RUN_MODE,                STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    //OPCODE( MSG_MOVE_SPLINE_SET_WALK_MODE,               STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    OPCODE( MSG_MOVE_SET_CAN_FLY,                        STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_UNSET_CAN_FLY,                      STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    OPCODE( MSG_MOVE_SET_CAN_FLY_ACK,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,  &WorldSession::HandleMoveSetCanFlyAckOpcode    );
    ...
    //OPCODE( CMSG_CHARACTER_CUSTOMIZE,                          STATUS_AUTHED,   PROCESS_THREADUNSAFE,  &WorldSession::HandleCharCustomize             );
    //OPCODE( SMSG_CHARACTER_CUSTOMIZE,                          STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE( MSG_MOVE_SPLINE_GRAVITY_DISABLE,             STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    //OPCODE( MSG_MOVE_SPLINE_GRAVITY_ENABLE,              STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE( CMSG_CHARACTER_FACTION_CHANGE,                     STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleCharFactionOrRaceChange    );
    //OPCODE( SMSG_CHARACTER_FACTION_CHANGE,                     STATUS_NEVER,    PROCESS_INPLACE,       &WorldSession::Handle_ServerSide               );
    ...
    //OPCODE( CMSG_CHARACTER_RACE_CHANGE,                        STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleCharFactionOrRaceChange    );
